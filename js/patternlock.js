...
function setPattern(){
	...
	if(pttrn==""){	
		blackberry.ui.dialog.standardAskAsync("Please, Draw a Pattern!", blackberry.ui.dialog.D_OK, null, {
			title: "Ops!"
		});
		...
		document.getElementById("password").value = "";
		localStorage.setItem("paternseted", 'done');
		localStorage.setItem("patern", pttrn);
...
function checkPattern(){
	unlockPattrn = parseInt(document.getElementById("password").value);
	pttrn = localStorage.getItem("patern");
